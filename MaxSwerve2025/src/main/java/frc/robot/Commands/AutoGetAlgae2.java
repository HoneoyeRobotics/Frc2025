...
public class AutoGetAlgae2 extends SequentialCommandGroup {
  /** Creates a new AutoGooooooood. */
  public AutoGetAlgae2(DriveSubsystem driveSubsystem, ClawevatorSubsystem clawevatorSubsystem,
      VisionSubsystem visionSubsystem) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(

        new SetClawevatorPosition(clawevatorSubsystem, ClawevatorPositions.Algae2),
