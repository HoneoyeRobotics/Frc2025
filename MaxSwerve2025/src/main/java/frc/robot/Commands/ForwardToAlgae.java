...
public class ForwardToAlgae extends Command {
  private final DriveSubsystem driveSubsystem;
  private final VisionSubsystem visionSubsystem;
  private final double speed;

  /** Creates a new CenterOnAprilTag. */
  public ForwardToAlgae(DriveSubsystem driveSubsystem, VisionSubsystem visionSubsystem, double speed) {
  ...
  public void execute() {
    ...
    double xoffset = (-0.911955 * visionSubsystem.getA()) - 4.56205;
    ...
    System.out.println("Offset is " + xoffset + " with power " + ySpeed);
  ...
  public boolean isFinished() {
    ...
    if (visionSubsystem.canSeeTag() && visionSubsystem.getA() > 17)
      return true;
